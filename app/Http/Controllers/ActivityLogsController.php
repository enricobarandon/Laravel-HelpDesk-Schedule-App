...
class ActivityLogsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $actions = [
            ...
            'logout' => 'Logout User',
            'login' => 'Login User',
            'post-request' => 'Posted a request to ocbs application',
            'remove-group' => 'Removed group from a schedule',
            'remove-confirmed-account' => 'Removed account from a scheduled group',
            'ocbs-manual-update' => 'Received a manual update from ocbs',
            'ocbs-create-user' => 'Received create user from ocbs',
            'ocbs-create-group' => 'Received create group from ocbs',
            'ocbs-update-operators' => 'Received update for operators status',
            'received-update' => 'Received update from a processed request. From ocbs.',
