        ...
        <a href="{{ url('/archive') }}" class="btn btn-primary">Back to Archive Link Page</a>
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fa fa-info-circle"></i> Create Archive</h3>
                    ...
                    <form action="{{ route('archive.submitArchive') }}" class="row" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bet_count" name="bet_count" value="{{ old('bet_count') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="transaction_count" name="transaction_count" value="{{ old('transaction_count') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="date_covered" name="date_covered" value="{{ old('date_covered') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fg_link" name="fg_link" value="{{ old('fg_link') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Kiosk Schedule Archive Link</label>
                                <input type="text" class="form-control" id="schedule_link" name="schedule_link" value="{{ old('schedule_link') }}" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="requested_by" name="requested_by" value="{{ old('requested_by') }}" required>
                            </div>
